...
constructor(props) {
    ...
    formaDadosDoUsuario() {
        ...
        render() {
            ...
            <View>
            <TextInput style={estilos.input} onChangeText={usuario => { this.setState({ usuario })
        }}
        ...
        value={this.state.usuario}>
            ...
            <View>
                <Button onPress={this.fetchDados} title="Buscar Dados" accessibilityLabel="Busque os dados do usuário no Git Hub" />
            </View>
        </View>
        )
    }
